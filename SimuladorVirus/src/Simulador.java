...
public class Simulador extends ApplicationFrame{
	final static XYSeries series  = new XYSeries ("valor médio");;
	static double r1, r2, r3, r4, lambda, pi_0, pi_p, pi_r, pi_f;
	static double media = 0.0, variancia = 0.0, desvio, confianca;
	...
	public Simulador(String title) {
		super(title);  
 
       final XYSeriesCollection data = new XYSeriesCollection(series);  
       final JFreeChart chart = ChartFactory.createXYLineChart("Custo X R4", "R4", "Custo",  
	...
	public static void main(String[] args){
		execucao();
		final Simulador demo = new Simulador("Grafico de Simulação");  
		demo.pack();  
